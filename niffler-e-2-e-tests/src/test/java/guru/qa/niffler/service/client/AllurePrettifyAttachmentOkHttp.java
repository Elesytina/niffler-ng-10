...
import guru.qa.niffler.model.allure.HttpAttachmentData;
...
public class AllurePrettifyAttachmentOkHttp extends AllureOkHttp3 {
    ...
    public Response intercept(final Chain chain) throws IOException {
        ...
        final HttpAttachmentData.HttpAttachmentDataBuilder requestAttachmentBuilder = new HttpAttachmentData().builder()
        ...
        final HttpAttachmentData requestAttachment = requestAttachmentBuilder.build();
        ...
        final HttpAttachmentData.HttpAttachmentDataBuilder responseAttachmentBuilder = new HttpAttachmentData().builder()
        ...
        final HttpAttachmentData responseAttachment = responseAttachmentBuilder.build();
        String responseTemplatePath = "http-response2.ftl";
